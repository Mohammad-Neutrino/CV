...
\noindent
\textbf{Ph.D. in Physics} \textit{2020--Present} \\
University of Kansas, USA \hfill \textbf{3.98/4.0}

\vspace{0em}
\noindent
\textbf{M.S. in Electrical Engineering}    \textit{2024--2025} \\
University of Kansas, USA \hfill \textbf{3.87/4.0}
...
\noindent
\textbf{Primary Analyzer, Askaryan Radio Array (ARA) Station 1}  \textit{2021--Present} \\
...
\vspace{0.em}
\noindent
\textbf{IceCube Neutrino Observatory Monitoring}  \textit{2021--2025} \\
Served as KU representative for monitoring shifts, presenting weekly reports to the collaboration.

\vspace{0.em}
\noindent
\textbf{Master's Thesis Research}  \textit{2019--2020} \\
...
\vspace{0.em}
\noindent
\textbf{Summer Research Program}  \textit{May--Jul 2019} \\
Institute of Physics, Bhubaneswar. Studied the role of $\theta_{13}$ mixing angle in three-flavor neutrino oscillations with Prof.\ S.K. Agarwalla, producing technical report ``Importance of 1-3 Mixing Angle in Three-Flavor Neutrino Oscillations Paradigm'' (\href{https://www.researchgate.net/publication/340095776_Importance_of_1-3_Mixing_Angle_in_Three-Flavor_Neutrino_Oscillations_Paradigm_SSVP_Summer_Project_Report}{DOI: 10.13140/RG.2.2.34421.12009}).

\vspace{0.em}
\noindent
\textbf{Winter Internship}  \textit{Dec 2019--Jan 2020} \\
Researched ``Weak Interaction Physics'' at IIT-BHU with Dr. G. Abbas.

\vspace{0.em}
\noindent
\textbf{Undergraduate Research Project}  \textit{2017--2018} \\
``Quarks \& Leptons'': Detailed study of Standard Model interactions with Prof.\ M.S. Athar at AMU \href{https://drive.google.com/file/d/11LsyY1QmncnjOGf1ZWpj7eTM-xcTbCNj/view?usp=sharing}{[View Handwritten Report]}.
...
\begin{itemize}
    ...
    \vspace{0.2em}
    \noindent
    \item \textbf{Seikh, M.F.H. for the ARA Collaboration} {\it (2024)}. ``Askaryan Radio Array: searching for the highest energy neutrinos". \textit{EPJ-ST}. \href{https://arxiv.org/abs/2411.01761}{arXiv:2411.01761} \href{https://doi.org/10.1140/epjs/s11734-025-01708-7}{DOI: 10.1140/epjs/s11734-025-01708-7}

    \vspace{0.2em}
    \noindent
        \item \textbf{Seikh, M.F.H. \& Besson, D.} {\it (2024)}. ``IceCube Neutrino Observatory: A Cold Discovery Hub". \href{https://drive.google.com/file/d/1q1vm4tf2Z8iK_Iw3n3kVayBnP7K6tHQI/view?usp=sharing}{\textit{Page 14-23, Physics Bulletin, Physics Department, AMU}}
...
\begin{itemize}
    ...
    \item ORCiD \orcidlink{0000-0002-4464-7354}
    \item \href{https://www.scopus.com/authid/detail.uri?authorId=57426893600}{Scopus}
\end{itemize}
...
\begin{itemize}
    \item {\bf Guest Editor} forSpringer's EPJ-ST journal: \href{https://link.springer.com/collections/ediiddhcdc}{``Radio Detection of Ultra-high Energy Neutrino \& Cosmic Rays"} (15 articles) with M.S. Athar, D. Besson, V. Grachev, and I. Karvchenko  \textit{(2024--2025)}
    ...
    \vspace{0.2em}
    \noindent  
    \item {\bf Founder and Editor-in-Chief} of \textit{The Magnetic Monopole} e-magazine for KU's Society of Physics Students
    %\href{https://kansas-my.sharepoint.com/personal/m725s436_home_ku_edu/Documents/Attachments/SPS_e-Magazine_Issue1.pdf}{[View Issue]}  \textit{(June 2022)}
    \href{https://drive.google.com/file/d/12yfhWqUupWIPWM5WcWdIviUYbVA2GnWY/view?usp=sharing}{[View Issue]}  \textit{(June 2022)}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{DPF Travel Award}, APS \textit{(2024)}
    \item \textbf{DPF Travel Grant}, APS \textit{(2022)}
...
\begin{itemize}
    \item \textbf{Washington DCs Scholarship}, Aligarh Alumni Association \textit{(2015--2019)}
...
\begin{itemize}
    ...
    \item Scored 10/10 in India's first \textbf{Science Leadership Workshop} \textit{(2020)}
...
\begin{itemize}
    \item \textbf{Responsible Conduct of Research}, (CITI Program, \textit{2021}) - 100\%
