...
\vspace{0.em}
\noindent
\textbf{Analysis Lead, Radio Background Characterization with ARA}  \textit{Dec 2025--Present} \\
Conducting data analysis on ``Characterizing Astrophysical and Environmental Phenomena with the Askaryan Radio Array" with Prof.\ D. Besson at University of Kansas (KU).
...
\vspace{0.em}
\noindent
\textbf{Machine Learning Project}  \textit{2025} \\
...
\begin{itemize}
    ...
    \vspace{0.0em}
    \noindent  
    \item {\bf SSGSA Application Reviewer:} for SSGSA (Multiple Applications) \textit{(2021, 2022, 2023, 2024, 2025)}
