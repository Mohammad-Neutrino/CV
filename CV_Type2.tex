...
\begin{center}
    {\bf \huge Curriculum Vitae}\\[0.05cm]
    ...
    \rule{\textwidth}{0.4pt}
    1251 Wescoe Hall Drive, Malott 6044, University of Kansas, Lawrence, KS, USA, 66044
\end{center}

% ------------------------------
\section*{Professional Objective}
To apply my training in experimental physics, radio-frequency engineering, signal processing, and data-driven analysis to research and development roles in academia, national laboratories, and industry, with a focus on instrumentation, detector systems, and advanced measurement technologies.
...
\begin{itemize}
    ...
    Title: ``Toward a Five-Station Diffuse Ultra-High Energy Neutrino Search with the Askaryan Radio Array: ARA01 Analysis Framework". Defended on May 8, 2026. Advised by Prof.\ D. Besson. Published on ProQuest \href{https://www.proquest.com/docview/3356640779/fulltextPDF/4CCB4101302F4FB5PQ}{ISBN: 9798252480190}.
...
\begin{itemize}
    ...
    \item \textbf{Primary Analyzer, Askaryan Radio Array (ARA) Station 1}  \textit{2021--2026} \\
    Conducted data analysis of ARA Station 1 for ultra-high energy (UHE) neutrino detection with Prof.\ D. Besson at University of Kansas (KU).

    \item \textbf{IceCube Neutrino Observatory Monitoring}  \textit{2021--2026} \\
...
\begin{itemize}
    ...
    \vspace{0.1em}
    \noindent
    \item \textbf{Seikh, M.F.H.} {\it (2025)}. ``A geometrical approach to neutrino oscillation parameters". {\it AIP Advances 1 Oct 2025; 15 (10): 105204}. \href{https://doi.org/10.1063/5.0292233}{DOI:10.1063/5.0292233}.
...
\begin{itemize}
    ...
    \vspace{0.1em}
    \noindent  
    \item {\bf Founder and Editor-in-Chief} of \textit{The Magnetic Monopole} e-magazine for KU's Society of Physics Students    \href{https://drive.google.com/file/d/12yfhWqUupWIPWM5WcWdIviUYbVA2GnWY/view?usp=sharing}{[View Issue]}  \textit{(Jun 2022)}
\end{itemize}
...
\begin{itemize}
    ...
    \vspace{0.0em}
    \noindent  
    \item {\bf Internal ARA Collaboration Reviewer:} Pawan Giri for ARA Collaboration, ``A Comprehensive Diffuse Neutrino Search Using the Full Askaryan Radio Array", 32nd International Symposium on Lepton Photon Interactions at High Energies \textit{(Nov 2025)}
...
\begin{itemize}
    ...
    \item {\bf General Cosmology:} for APS Global Physics Summit (Mar 19, 2026)

    \vspace{0.0em}
    \noindent  
    \item {\bf Topical Groups Session II:} for APS Global Physics Summit (Mar 17, 2026)
...
\begin{itemize}
    \item {\bf Junior Participant Support}, Neutrino \textit{(2026)}
...
\begin{itemize}
    ...
    \item \textbf{Searching for the Universe's Highest-Energy Neutrinos with Radio Detectors}\\
    Particle Physics Seminar, Carnegie Mellon University \textit{(Sep 9, 2026)}

    \item \textbf{Radio Engineering for Particle Astrophysics Experiments}\\
    HEP Seminar, University of Nebraska-Lincoln \textit{(Mar 26, 2025)}
    
    \item \textbf{Radio Engineering for Particle Astrophysics Experiments} \\
    Astroparticle Seminar, Ohio State University \textit{(Jan 22, 2025)}
    
    \item \textbf{Radio Engineering \& Antenna Physics} \\
    Lecture Series, IEI Summer School 2024, University of Alaska, Anchorage \textit{(Jul 2--5, 2024)}
    
    \item \textbf{UHE Neutrino \& Cosmic Ray Detectors} \\
    ICEHAP Seminar, Chiba University, Japan \textit{(Aug 9, 2023)}
    
    \item \textbf{Antenna Physics \& Measurements} \\
    Lecture Series, IEI Summer School 2023, South Dakota School of Mines \textit{(Jul 2--5, 2023)}
    
    \item \textbf{UHE Neutrino \& Cosmic Ray Detectors} \\
    Physics Colloquium, AMU, India \textit{(Jan 12, 2023)}
    
    \item \textbf{Antennas in UHE Neutrino Detectors} \\
    Particle Physics Seminar, University of Delaware \textit{(Oct 4, 2022)}
\end{itemize}

% ------------------------------
\section*{Outreach \& Leadership}
\begin{itemize}
    \item Co-organized and hosted India's inaugural workshop on \textbf{Radio Detection of UHE Neutrino and Cosmic Rays} at AMU \textit{(Apr 2024)}
...
\begin{itemize}
    ...
    APS Global Physics Summit \textit{(Mar 18, 2026)}

    \item \textbf{RNO-G in-ice Antennas} \\
    RNO-G Collaboration Meeting, Uppsala University \textit{(Sep 9--14, 2024)}
    
    \item \textbf{Radio Frequency Instrumentation} \\
    Radio Neutrino Workshop, AMU, India \textit{(Apr 18--20, 2024)}
    
    \item \textbf{Towards Five Station ARA Analysis} \\
    APS April Meeting, Sacramento \textit{(Apr 3--6, 2024)}
    
    \item \textbf{ARA Antenna Models} \\
    ARA Collaboration Meeting, Ohio State University \textit{(Mar 5--8, 2024)}
    
    \item \textbf{Current Status \& Future of ARA} \\
    APS Prairie Section Meeting, University of Missouri \textit{(Nov 30--Dec 2, 2023)}
    
    \item \textbf{Introduction to Antenna Physics} \\
    RET Collaboration Meeting, Vrije University Brussels \textit{(Nov 8--11, 2023)}
    
    \item \textbf{Gain Calibration of RNO-G Antennas} \\
    RNO-G Fall Meeting, Penn State University \textit{(Sep 11--15, 2023)}

    \item \textbf{Galactic Noise in Radio Neutrino Experiments} \\
    Astro Seminar, KU \textit{(Oct 28, 2022)}
    
    \item \textbf{Towards ARA Station 1 Calibration} \\
    APS April Meeting, New York City \textit{(Apr 9--12, 2022)}
    
    \item \textbf{RNO-G Ice Calibration Planning} \\
    RNO-G Collaboration Meeting, University of Chicago \textit{(Apr 8, 2022)}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{A Diffuse Search for UHE Cosmogenic Neutrinos with ARA Five Stations} \\
    Neutrino 2026, UC Irvine \textit{(Jun 21--26, 2026)}

    \item \textbf{Monitoring Snow Accumulation in ARA Using DAQ Temperature Data} \\
    Neutrino 2026, UC Irvine \textit{(Jun 21--26, 2026)}

    \item \textbf{A Geometrical Approach to Neutrino Oscillation Parameters} \\
    APS Global Physics Summit \textit{(Mar 17, 2026)}
    
    \item \textbf{CW Identification \& Filtering Techniques in ARA} \\
    39th ICRC, Geneva, Switzerland \textit{(Jul 19, 2025)}
    
    \item \textbf{Observation of radio solar flares in RNO-G} \\
    39th ICRC, Geneva, Switzerland \textit{(Jul 15, 2025)}
    
    \item \textbf{Gain Measurements of LPDA Antennas} \\
    APS April Meeting, Sacramento \textit{(Apr 3--6, 2024)}
    
    \item \textbf{Overview of ARA Detector: Five Station Analysis} \\
    ICTS Neutrino School, India \textit{(Apr 22--May 3, 2024)}
    
    \item \textbf{Calibration of ARA Station 1} \\
    38th ICRC, Nagoya University, Japan \textit{(Jul 29, 2023)}
...
\begin{itemize}
    \item \textbf{The AI Masterclass 3.0}, (Dhruv Rathee Academy, \textit{May 2026})  
